...
/* Respond List Plugin
 * <div respond-plugin type="list" display="list|thumbnail|map|simple" url="page/"></div>
 */
...
// add ul for simple lists
if ($attributes['display'] == 'simple') {
  $html .= '<ul>';
}
...
foreach ($pages as $page) {
  ...
  if (url_starts_with($page['url'], $attributes['url'])) {
    ...
    else if ($attributes['display'] == 'simple') {
